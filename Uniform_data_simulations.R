...
Z_array_full_udat=Z_array_full
ZI_array_full_udat=ZI_array_full
Z_array_mult_udat=Z_array_mult
ZI_array_mult_udat=ZI_array_mult


save(Z_array_full_udat, file="Z_array_full_udat.Rda")
save(ZI_array_full_udat, file="ZI_array_full_udat.Rda")

save(Z_array_mult_udat, file="Z_array_mult_udat.Rda")
save(ZI_array_mult_udat, file="ZI_array_mult_udat.Rda")



sse_vec_mult_udat=sse_vec_mult
alpha_vec_mult_udat=alpha_vec_mult
predZ_store_mult_udat=predZ_store_mult
alpha_store_mult_udat=alpha_store_mult
sse_vec_mult_udat=sse_vec_mult
alpha_vec_mult_udat=alpha_vec_mult
sigma_vec_mult_udat=sigma_vec_mult
logphi_vec_mult_udat=logphi_vec_mult
tau_vec_mult_udat=tau_vec_mult
mp_vec_mult_udat=mp_vec_mult
alpha_sd_mult_udat=alpha_sd_mult
sigma_sd_mult_udat=sigma_sd_mult
logphi_sd_mult_udat=logphi_sd_mult
tau_sd_mult_udat=tau_sd_mult
mp_sd_mult_udat=mp_sd_mult



predZ_store_full_udat=predZ_store_full
Z_store_udat=Z_store
alpha_store_full_udat=alpha_store_full
beta_store_full_udat=beta_store_full
sse_vec_full_udat=sse_vec_full
alpha_vec_full_udat=alpha_vec_full
beta_vec_full_udat=beta_vec_full
sse_vec_full_udat=sse_vec_full
alpha_vec_full_udat=alpha_vec_full
beta_vec_full_udat=beta_vec_full
sigma_vec_full_udat=sigma_vec_full
logphi_vec_full_udat=logphi_vec_full
tau_vec_full_udat=tau_vec_full
mp_vec_full_udat=mp_vec_full
alpha_sd_full_udat=alpha_sd_full
beta_sd_full_udat=beta_sd_full
sigma_sd_full_udat=sigma_sd_full
logphi_sd_full_udat=logphi_sd_full
tau_sd_full_udat=tau_sd_full
mp_sd_full_udat=mp_sd_full




####
save(sse_vec_mult_udat, file="sse_vec_mult_udat.Rda")
save(alpha_vec_mult_udat, file="alpha_vec_mult_udat.Rda")
save(predZ_store_mult_udat, file="predZ_store_mult_udat.Rda")
save(alpha_store_mult_udat, file="alpha_store_mult_udat.Rda")
save(sse_vec_mult_udat, file="sse_vec_mult_udat.Rda")
save(alpha_vec_mult_udat, file="alpha_vec_mult_udat.Rda")
save(sigma_vec_mult_udat, file="sigma_vec_mult_udat.Rda")
save(logphi_vec_mult_udat, file="logphi_vec_mult_udat.Rda")
save(tau_vec_mult_udat, file="tau_vec_mult_udat.Rda")
save(mp_vec_mult_udat, file="mp_vec_mult_udat.Rda")
save(alpha_sd_mult_udat, file="alpha_sd_mult_udat.Rda")
save(sigma_sd_mult_udat, file="sigma_sd_mult_udat.Rda")
save(logphi_sd_mult_udat, file="logphi_sd_mult_udat.Rda")
save(tau_sd_mult_udat, file="tau_sd_mult_udat.Rda")
save(mp_sd_mult_udat, file="mp_sd_mult_udat.Rda")



save(predZ_store_full_udat, file="predZ_store_full_udat.Rda")
save(Z_store_udat, file="Z_store_udat.Rda")
save(alpha_store_full_udat, file="alpha_store_full_udat.Rda")
save(beta_store_full_udat, file="beta_store_full_udat.Rda")
save(sse_vec_full_udat, file="sse_vec_full_udat.Rda")
save(alpha_vec_full_udat, file="alpha_vec_full_udat.Rda")
save(beta_vec_full_udat, file="beta_vec_full_udat.Rda")
save(sse_vec_full_udat, file="sse_vec_full_udat.Rda")
save(alpha_vec_full_udat, file="alpha_vec_full_udat.Rda")
save(beta_vec_full_udat, file="beta_vec_full_udat.Rda")
save(sigma_vec_full_udat, file="sigma_vec_full_udat.Rda")
save(logphi_vec_full_udat, file="logphi_vec_full_udat.Rda")
save(tau_vec_full_udat, file="tau_vec_full_udat.Rda")
save(mp_vec_full_udat, file="mp_vec_full_udat.Rda")
save(alpha_sd_full_udat, file="alpha_sd_full_udat.Rda")
save(beta_sd_full_udat, file="beta_sd_full_udat.Rda")
save(sigma_sd_full_udat, file="sigma_sd_full_udat.Rda")
save(logphi_sd_full_udat, file="logphi_sd_full_udat.Rda")
save(tau_sd_full_udat, file="tau_sd_full_udat.Rda")
save(mp_sd_full_udat, file="mp_sd_full_udat.Rda")

#UDAT
alpha_store_mult_udat=alpha_store_mult
sigma_store_mult_udat=sigma_store_mult
logphi_store_mult_udat=logphi_store_mult
tau_store_mult_udat=tau_store_mult
mp_store_mult_udat=mp_store_mult

alpha_store_full_udat=alpha_store_full
beta_store_full_udat=beta_store_full
sigma_store_full_udat=sigma_store_full
logphi_store_full_udat=logphi_store_full
tau_store_full_udat=tau_store_full
mp_store_full_udat=mp_store_full


save(alpha_store_mult_udat, file="alpha_store_mult_udat.Rda")
save(sigma_store_mult_udat, file="sigma_store_mult_udat.Rda")
save(logphi_store_mult_udat, file="logphi_store_mult_udat.Rda")
save(tau_store_mult_udat, file="tau_store_mult_udat.Rda")
save(mp_store_mult_udat, file="mp_store_mult_udat.Rda")

save(alpha_store_full_udat, file="alpha_store_full_udat.Rda")
save(beta_store_full_udat, file="beta_store_full_udat.Rda")
save(sigma_store_full_udat, file="sigma_store_full_udat.Rda")
save(logphi_store_full_udat, file="logphi_store_full_udat.Rda")
save(tau_store_full_udat, file="tau_store_full_udat.Rda")
save(mp_store_full_udat, file="mp_store_full_udat.Rda")
