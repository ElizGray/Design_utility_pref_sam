...
#now with multinomial data for comparison 
...
for(p in 1:repeats){
  ...
  design_vec=sample(N,n,replace=TRUE,prob=exp(alpha*Z))
...
Z_array_full_mdat=Z_array_full
ZI_array_full_mdat=ZI_array_full
Z_array_mult_mdat=Z_array_mult
ZI_array_mult_mdat=ZI_array_mult


save(Z_array_full_mdat, file="Z_array_full_mdat.Rda")
save(ZI_array_full_mdat, file="ZI_array_full_mdat.Rda")

save(Z_array_mult_mdat, file="Z_array_mult_mdat.Rda")
save(ZI_array_mult_mdat, file="ZI_array_mult_mdat.Rda")

sse_vec_mult_mdat=sse_vec_mult
alpha_vec_mult_mdat=alpha_vec_mult
predZ_store_mult_mdat=predZ_store_mult
alpha_store_mult_mdat=alpha_store_mult
sse_vec_mult_mdat=sse_vec_mult
alpha_vec_mult_mdat=alpha_vec_mult
sigma_vec_mult_mdat=sigma_vec_mult
logphi_vec_mult_mdat=logphi_vec_mult
tau_vec_mult_mdat=tau_vec_mult
mp_vec_mult_mdat=mp_vec_mult
alpha_sd_mult_mdat=alpha_sd_mult
sigma_sd_mult_mdat=sigma_sd_mult
logphi_sd_mult_mdat=logphi_sd_mult
tau_sd_mult_mdat=tau_sd_mult
mp_sd_mult_mdat=mp_sd_mult



predZ_store_full_mdat=predZ_store_full
Z_store_mdat=Z_store
alpha_store_full_mdat=alpha_store_full
beta_store_full_mdat=beta_store_full
sse_vec_full_mdat=sse_vec_full
alpha_vec_full_mdat=alpha_vec_full
beta_vec_full_mdat=beta_vec_full
sse_vec_full_mdat=sse_vec_full
alpha_vec_full_mdat=alpha_vec_full
beta_vec_full_mdat=beta_vec_full
sigma_vec_full_mdat=sigma_vec_full
logphi_vec_full_mdat=logphi_vec_full
tau_vec_full_mdat=tau_vec_full
mp_vec_full_mdat=mp_vec_full
alpha_sd_full_mdat=alpha_sd_full
beta_sd_full_mdat=beta_sd_full
sigma_sd_full_mdat=sigma_sd_full
logphi_sd_full_mdat=logphi_sd_full
tau_sd_full_mdat=tau_sd_full
mp_sd_full_mdat=mp_sd_full

save(sse_vec_mult_mdat, file="sse_vec_mult_mdat.Rda")
save(alpha_vec_mult_mdat, file="alpha_vec_mult_mdat.Rda")
save(predZ_store_mult_mdat, file="predZ_store_mult_mdat.Rda")
save(alpha_store_mult_mdat, file="alpha_store_mult_mdat.Rda")
save(sse_vec_mult_mdat, file="sse_vec_mult_mdat.Rda")
save(alpha_vec_mult_mdat, file="alpha_vec_mult_mdat.Rda")
save(sigma_vec_mult_mdat, file="sigma_vec_mult_mdat.Rda")
save(logphi_vec_mult_mdat, file="logphi_vec_mult_mdat.Rda")
save(tau_vec_mult_mdat, file="tau_vec_mult_mdat.Rda")
save(mp_vec_mult_mdat, file="mp_vec_mult_mdat.Rda")
save(alpha_sd_mult_mdat, file="alpha_sd_mult_mdat.Rda")
save(sigma_sd_mult_mdat, file="sigma_sd_mult_mdat.Rda")
save(logphi_sd_mult_mdat, file="logphi_sd_mult_mdat.Rda")
save(tau_sd_mult_mdat, file="tau_sd_mult_mdat.Rda")
save(mp_sd_mult_mdat, file="mp_sd_mult_mdat.Rda")



save(predZ_store_full_mdat, file="predZ_store_full_mdat.Rda")
save(Z_store_mdat, file="Z_store_mdat.Rda")
save(alpha_store_full_mdat, file="alpha_store_full_mdat.Rda")
save(beta_store_full_mdat, file="beta_store_full_mdat.Rda")
save(sse_vec_full_mdat, file="sse_vec_full_mdat.Rda")
save(alpha_vec_full_mdat, file="alpha_vec_full_mdat.Rda")
save(beta_vec_full_mdat, file="beta_vec_full_mdat.Rda")
save(sse_vec_full_mdat, file="sse_vec_full_mdat.Rda")
save(alpha_vec_full_mdat, file="alpha_vec_full_mdat.Rda")
save(beta_vec_full_mdat, file="beta_vec_full_mdat.Rda")
save(sigma_vec_full_mdat, file="sigma_vec_full_mdat.Rda")
save(logphi_vec_full_mdat, file="logphi_vec_full_mdat.Rda")
save(tau_vec_full_mdat, file="tau_vec_full_mdat.Rda")
save(mp_vec_full_mdat, file="mp_vec_full_mdat.Rda")
save(alpha_sd_full_mdat, file="alpha_sd_full_mdat.Rda")
save(beta_sd_full_mdat, file="beta_sd_full_mdat.Rda")
save(sigma_sd_full_mdat, file="sigma_sd_full_mdat.Rda")
save(logphi_sd_full_mdat, file="logphi_sd_full_mdat.Rda")
save(tau_sd_full_mdat, file="tau_sd_full_mdat.Rda")
save(mp_sd_full_mdat, file="mp_sd_full_mdat.Rda")

alpha_store_mult_mdat=alpha_store_mult
sigma_store_mult_mdat=sigma_store_mult
logphi_store_mult_mdat=logphi_store_mult
tau_store_mult_mdat=tau_store_mult
mp_store_mult_mdat=mp_store_mult

alpha_store_full_mdat=alpha_store_full
beta_store_full_mdat=beta_store_full
sigma_store_full_mdat=sigma_store_full
logphi_store_full_mdat=logphi_store_full
tau_store_full_mdat=tau_store_full
mp_store_full_mdat=mp_store_full


save(alpha_store_mult_mdat, file="alpha_store_mult_mdat.Rda")
save(sigma_store_mult_mdat, file="sigma_store_mult_mdat.Rda")
save(logphi_store_mult_mdat, file="logphi_store_mult_mdat.Rda")
save(tau_store_mult_mdat, file="tau_store_mult_mdat.Rda")
save(mp_store_mult_mdat, file="mp_store_mult_mdat.Rda")

save(alpha_store_full_mdat, file="alpha_store_full_mdat.Rda")
save(beta_store_full_mdat, file="beta_store_full_mdat.Rda")
save(sigma_store_full_mdat, file="sigma_store_full_mdat.Rda")
save(logphi_store_full_mdat, file="logphi_store_full_mdat.Rda")
save(tau_store_full_mdat, file="tau_store_full_mdat.Rda")
save(mp_store_full_mdat, file="mp_store_full_mdat.Rda")
